<div class="col-xl-4 col-lg-6 col-md-6 role-card mb-2" id="role_card_{{ $role->id }}">
            ...
            @if (!$role->isAdmin())
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        <a class="dropdown-item role-edit" data-url-edit="{{ route('roles.edit', $role) }}"
                    ...
                    @foreach ($role->users as $key => $user)
                        @if ($key > 5)
                            <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                                title="{{ $user->full_name }}" class="avatar avatar-sm pull-up" style="margin: 1px">
                        ...
                        @else
                            <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                                ...
                                <img class="rounded-circle"
                                    src="{{ $user->avatar ?? asset('images/avatars/2.png') }}" alt="Avatar" />
                            </li>
                        @endif
                    @endforeach
                </ul>
