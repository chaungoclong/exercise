<!-- Add Role Modal -->
<div class="modal fade" id="createRoleModal" data-bs-backdrop="static" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered modal-add-new-role">
    <div class="modal-content">
      ...
      <div class="modal-body px-5 pb-5">
        ...
        <!-- Add role form -->
        <form id="createRoleForm" class="row" action="{{ route('roles.store') }}">
          <div class="col-6">
          ...
          <div class="col-6">
            ...
            <input type="text" id="slug" name="slug" class="form-control" placeholder="Enter role slug"
              tabindex="-1" />
          </div>
          <div class="col-12">
