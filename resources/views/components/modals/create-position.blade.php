<!-- Add Position Modal -->
<div class="modal fade" id="createPositionModal" data-bs-backdrop="static" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body px-5 pb-5">
                <div class="text-center mb-4">
                    <h1 class="position-title">Add New Position</h1>
                </div>
                <!-- Add Position form -->
                <form id="createPositionForm" class="row" action="{{ route('positions.store') }}">
                    <div class="col-12">
