((document, $) => {
    ...
    $(function () {
        ...
        let $saveReportModal = $('#saveReportManagerModal');
        let saveReportModal = new bootstrap.Modal($saveReportModal[0]);
        let $saveReportForm = $('#saveReportManagerForm');
        ...
        // Function load project select when user select is changed
